<template>
    <div class="golden-ticket">
        <common-table alert_code="511" :alert_list="alert_list" :column_list="column_list" @row_click="row_click"></common-table>
        <div class="detail">
...
export default {
    ...
    data() {
        return {
        	index: 0,
            column_list: ["source_ip", "source_workstation", "target_user_name", "service_name", "enc_type"]
        }
    },
    created() {
