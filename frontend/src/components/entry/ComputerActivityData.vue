<template>
    <div class="computer-activity-data">
        <div class="data-statistic">
            ...
            <statistic-item :img_path="user_img" name="登录用户" type="logon_users" :data_list="logon_users"></statistic-item>
        </div>
        <div class="computer-activity-records">
            <div class="top-info">
                <div class="filter">
                    <DatePicker 
            ...
            <div :class="{'records-null-content': real_data.length == 0}">
                <Scroll v-show="real_data.length > 0" :on-reach-bottom="search" height="716">
...
export default {
    ...
    created() {
        ...
        this.$store.dispatch("get_entry_logon_users");
    ...
    computed: {
        ...mapState({
            ...
            logon_users: state => state.index.logon_users,
