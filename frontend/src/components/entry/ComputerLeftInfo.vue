<template>
    <div class="computer-left-intro">
        <div class="avatar-info">
            <div class="avatar-outer">
                <div class="avatar-wrapper">
                    <Icon color="#0294FF" class="avatar-icon" size="35" custom="iconfont icon-computer" />
                </div>
                <div>
                    <Icon v-if="sensitive" title="敏感计算机" color="#19be6b" class="avatar-flag" size="30" custom="iconfont icon-privilege-o" />
                </div>
            </div>
            <div class="name">
                {{displayName}}
        ...
        <div class="detail-info">
            <div class="base-info">
                ...
                <Row>
                    ...
                    <Col span="12">
                        <div class="item-name">Last Logon</div>
                        <div class="item-value">{{lastLogonTimestamp}}</div>
                    </Col>
                </Row>
            </div>
