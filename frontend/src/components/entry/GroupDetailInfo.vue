        ...
        <div class="base-info">
            <div class="account-info">
                ...
                <div class="account-content">
                    <div><div class="item-name">SAM 名称</div> <div class="item-value">{{detail_data["sAMAccountName"]}}</div></div>
                    <div><div class="item-name">SID</div> <div class="item-value">{{detail_data["objectSid"]}}</div></div>
                    <div><div class="item-name">DN</div> <div class="item-value">{{detail_data["distinguishedName"]}}</div></div>
                </div>
            </div>
            ...
            <div class="members">
                ...
                <div class="members-content">
                    <div class="direct-members">
                        <div class="sub-title">直接成员（{{direct_members.length}}）</div>
                        <div class="item-list">
                            <multi-entry-item 
                            v-for="member in direct_members" 
                            :keys="member['cn']"
                            :name="member['cn']"
                            :domain="domain"
                            :is_sensitive="member['is_sensitive']"
                            :is_disabled="member['is_disabled']"
                            :disable_poptip="false"
                            :entry_type="member['entry_type']"></multi-entry-item>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    mounted() {
        this.$store.dispatch("get_detail_group");
    },
    computed: {
        ...mapState({
